...
# --------------------------------------------------------
_base_ = [
    '../_base_/models/upernet_r50.py', '../_base_/datasets/wp_degraded_only.py',
...
model = dict(
    ...
    decode_head=dict(num_classes=10, in_channels=[160, 320, 640, 1280]),
    auxiliary_head=dict(num_classes=10, in_channels=640),
